...
class ADSPORTS extends StatelessWidget {
  const ADSPORTS({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getadsport(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("AD SPORTS"),

                ),
                body: ConditionalBuilder(
                  condition: app.adsport.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.adsport, context: context),
                  fallback: (context) =>
