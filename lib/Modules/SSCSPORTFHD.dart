...
class SSCSPORTFHD extends StatelessWidget {


  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getsscfhd(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("SSC SPORT FHD"),
                ),
                body: ConditionalBuilder(
                  condition: app.sscfhd.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.sscfhd, context: context),
                  fallback: (context) =>
