...
class beINSPORTSSD extends StatelessWidget {


  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getbeinsd(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("beIN SPORTS SD"),
                ),
                body: ConditionalBuilder(
                  condition: app.beinsd.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.beinsd, context: context),
                  fallback: (context) =>
