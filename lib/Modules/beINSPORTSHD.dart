...
class beINSPORTSHD extends StatelessWidget {
  const beINSPORTSHD({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getbeinhd(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("beIN SPORTS HD"),
                ),
                body: ConditionalBuilder(
                  condition: app.beinhd.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.beinhd, context: context),
                  fallback: (context) =>
