...
class ArabicSPORT extends StatelessWidget {
  const ArabicSPORT({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..arsport,
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("Arabic SPORT"),
                ),
                body: ConditionalBuilder(
                  condition: app.arsport.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.arsport, context: context),
                  fallback: (context) =>
