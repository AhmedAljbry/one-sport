...
class beINSPORTSHEVC extends StatelessWidget {
  const beINSPORTSHEVC({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getbeinhevc(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("beIN SPORTS HEVC"),
                ),
                body: ConditionalBuilder(
                  condition: app.beinhevc.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.beinhevc, context: context),
                  fallback: (context) =>
