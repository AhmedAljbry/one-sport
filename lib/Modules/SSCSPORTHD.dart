...
import '../shared/Cubit/stales.dart';


class SSCSPORTHD extends StatelessWidget {


  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getsschd(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("SSC SPORT HD"),
                ),
                body: ConditionalBuilder(
                  condition: app.sschd.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.sschd, context: context),
                  fallback: (context) =>
