...
class SSCSPORTLOW extends StatelessWidget {


  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getssclow(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("SSC SPORT LOW"),
                ),
                body: ConditionalBuilder(
                  condition: app.ssclow.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.ssclow, context: context),
                  fallback: (context) =>
