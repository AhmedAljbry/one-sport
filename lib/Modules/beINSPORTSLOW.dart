...
class beINSPORTSLOW extends StatelessWidget {
  const beINSPORTSLOW({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getbeinlow(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("beINSPORTSLOW"),
                ),
                body: ConditionalBuilder(
                  condition: app.beinlow.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.beinlow, context: context),
                  fallback: (context) =>
