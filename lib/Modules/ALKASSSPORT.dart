...
class ALKASSSPORT extends StatelessWidget {
  const ALKASSSPORT({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getalkass(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("AL KASS SPORT"),
                ),
                body: ConditionalBuilder(
                  condition: app.alkass.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.alkass, context: context),
                  fallback: (context) =>
