...
class beINSport4K extends StatelessWidget {
  const beINSport4K({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => AppCubit()..getbein4k(),
        ...
        builder: (context, state) {
          ...
          return Container(
            ...
            child: Scaffold(
                ...
                appBar: AppBar(
                  title: Text("beIN Sport 4K"),
                ),
                body: ConditionalBuilder(
                  condition: app.bein4k.length > 0,
                  builder: (context) =>
                      Gradbuild(modle: app.bein4k, context: context),
                  fallback: (context) =>
